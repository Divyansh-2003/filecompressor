...
def compress_pdf_ghostscript(input_path, output_path, level):
    quality_map = {
        "95": "/prepress", "90": "/printer", "85": "/printer", "80": "/ebook",
        "75": "/ebook", "70": "/screen", "65": "/screen", "60": "/screen",
        "55": "/screen", "50": "/screen", "45": "/screen", "40": "/screen",
        "35": "/screen", "30": "/screen"
    }
...
# --- Compress selected PDFs with progress ---
def apply_selected_compression(pdf_files, compression_level):
    compressed_files = []
    progress = st.progress(0, text="Compressing PDFs...")
    total = len(pdf_files)
